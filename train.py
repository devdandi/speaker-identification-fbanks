...
from dataset.FBanksCrossEntropyDataset import FBanksCrossEntropyDataset
from models.FBankCrossEntropyNet import FBankCrossEntropyNet
from util import restore_objects, save_model, save_objects, restore_objects,restore_model
...
def main():
    ...
    train_dataset = FBanksCrossEntropyDataset('dataset/fbanks_train')
    train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, **kwargs)

    test_dataset = FBanksCrossEntropyDataset('dataset/fbanks_test')
